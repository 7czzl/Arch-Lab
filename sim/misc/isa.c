...
instr_t instruction_set[] = 
{
	...
	{"isubl",  HPACK(I_ISUBL, F_NONE), 6, I_ARG, 2, 4, R_ARG, 1, 0 },
...
stat_t step_state(state_ptr s, FILE *error_file)
{
	...
	(hi0 == I_RRMOVL || hi0 == I_ALU || hi0 == I_PUSHL ||
	 ...
	 hi0 == I_MRMOVL || hi0 == I_IADDL || hi0 == I_RMXCHG || hi0 == I_ISUBL);
	...
	(hi0 == I_IRMOVL || hi0 == I_RMMOVL || hi0 == I_MRMOVL ||
	 hi0 == I_JMP || hi0 == I_CALL || hi0 == I_IADDL || hi0 == I_RMXCHG || hi0 == I_ISUBL);
